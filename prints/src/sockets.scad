...
cherrymx_socket_wall_thickness = 4.5;

cherrymx_socket_hull_dx = cherrymx_socket_body_dx + 2*cherrymx_socket_wall_thickness;
cherrymx_socket_hull_dy = cherrymx_socket_body_dy + 2*cherrymx_socket_wall_thickness;
